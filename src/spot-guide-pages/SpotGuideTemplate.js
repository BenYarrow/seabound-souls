...
const SpotGuideTemplate = ({
  ...
  return (
    <div>
      ...
      <StaticMasthead
        image={spotGuide.masthead}
        title={spotGuide.title}
        subtitle={spotGuide.location}
      />
      ...
      <div id="content" className="relative">
        ...
        <BlockWrapper padded>
          <div className="flex justify-around w-full">
            <div className="flex flex-col items-center gap-y-1 lg:gap-y-2">
              <p className="text-sm lg:text-xl text-left">Beginner</p>
              <div className="flex gap-x-1">
                <FontAwesomeIcon
                  icon={faStar}
                  className={`${
                    spotGuide.b1 ? "text-blue-lighter" : "text-white-darker"
                  } text-sm lg:text-base`}
                />
                <FontAwesomeIcon
                  icon={faStar}
                  className={`${
                    spotGuide.b2 ? "text-blue-lighter" : "text-white-darker"
                  } text-sm lg:text-base`}
                />
                <FontAwesomeIcon
                  icon={faStar}
                  className={`${
                    spotGuide.b3 ? "text-blue-lighter" : "text-white-darker"
                  } text-sm lg:text-base`}
                />
                <FontAwesomeIcon
                  icon={faStar}
                  className={`${
                    spotGuide.b4 ? "text-blue-lighter" : "text-white-darker"
                  } text-sm lg:text-base`}
                />
                <FontAwesomeIcon
                  icon={faStar}
                  className={`${
                    spotGuide.b5 ? "text-blue-lighter" : "text-white-darker"
                  } text-sm lg:text-base`}
                />
              </div>
            </div>
            <div className="flex flex-col items-center gap-y-1 lg:gap-y-2">
              <p className="text-sm lg:text-xl text-left">Intermediate</p>
              <div className="flex gap-x-1">
                <FontAwesomeIcon
                  icon={faStar}
                  className={`${
                    spotGuide.i1 ? "text-blue-lighter" : "text-white-darker"
                  } text-sm lg:text-base`}
                />
                <FontAwesomeIcon
                  icon={faStar}
                  className={`${
                    spotGuide.i2 ? "text-blue-lighter" : "text-white-darker"
                  } text-sm lg:text-base`}
                />
                <FontAwesomeIcon
                  icon={faStar}
                  className={`${
                    spotGuide.i3 ? "text-blue-lighter" : "text-white-darker"
                  } text-sm lg:text-base`}
                />
                <FontAwesomeIcon
                  icon={faStar}
                  className={`${
                    spotGuide.i4 ? "text-blue-lighter" : "text-white-darker"
                  } text-sm lg:text-base`}
                />
                <FontAwesomeIcon
                  icon={faStar}
                  className={`${
                    spotGuide.i5 ? "text-blue-lighter" : "text-white-darker"
                  } text-sm lg:text-base`}
                />
              </div>
            </div>
            <div className="flex flex-col items-center gap-y-1 lg:gap-y-2 ">
              <p className="text-sm lg:text-xl text-left">Advanced</p>
              <div className="flex gap-x-1">
                <FontAwesomeIcon
                  icon={faStar}
                  className={`${
                    spotGuide.a1 ? "text-blue-lighter" : "text-white-darker"
                  } text-sm lg:text-base`}
                />
                <FontAwesomeIcon
                  icon={faStar}
                  className={`${
                    spotGuide.a2 ? "text-blue-lighter" : "text-white-darker"
                  } text-sm lg:text-base`}
                />
                <FontAwesomeIcon
                  icon={faStar}
                  className={`${
                    spotGuide.a3 ? "text-blue-lighter" : "text-white-darker"
                  } text-sm lg:text-base`}
                />
                <FontAwesomeIcon
                  icon={faStar}
                  className={`${
                    spotGuide.a4 ? "text-blue-lighter" : "text-white-darker"
                  } text-sm lg:text-base`}
                />
                <FontAwesomeIcon
                  icon={faStar}
                  className={`${
                    spotGuide.a5 ? "text-blue-lighter" : "text-white-darker"
                  } text-sm lg:text-base`}
                />
              </div>
            </div>
        ...
        {spotGuide.intro && (
          <BlockWrapper padded={false} customClasses="mg-8 lg:mb-12">
            <div className="border-y border-blue-lighter">
              <Text content={spotGuide.intro} centredText />
            </div>
          </BlockWrapper>
        )}
        ...
        {spotGuide.galleryImages && (
          <Gallery images={spotGuide.galleryImages} />
        )}
        ...
        {spotGuide.whenToGoDetails && (
          <div id="when-to-go">
            <BlockWrapper>
              <Text title="When to go" content={spotGuide.whenToGoDetails} />
            </BlockWrapper>
          </div>
        )}
        ...
        {spotGuide.spotImage && spotGuide.spots ? (
          ...
          spotGuide.spots && (
            <div id="spots">
              <BlockWrapper>
                <Text title="Spots" content={spotGuide.spots} />
              </BlockWrapper>
            </div>
          )
        )}
        ...
        {spotGuide.gettingHereImage && spotGuide.gettingHereText ? (
        ...
        spotGuide.travellingImage ? (
          ...
          (spotGuide.travellingBulletData && (
            <div id="travelling-around">
              <Bulletpoints
                title="Travelling around"
                intro={spotGuide.travellingIntro}
        ...
        {(spotGuide.whereToEatBulletData || spotGuide.eatIntro) &&
        spotGuide.eatImage ? (
          <div id="where-to-eat">
            <ImageAndBullets
