export let spotGuideCoordinates = {
    leMorne: {
        marker: {
            title: 'Le Morne',
            link: '/destinations/le-morne-spot-guide',
            coordinates: {
                lat: -20.460852,
                long: 57.314262
            }
    ...
    riscoDelPaso: {
        marker: {
            ...
            link: '/destinations/risco-del-paso-spot-guide',
            coordinates: {
                lat: 28.110461,
                long: -14.261792
            },
        ...
        markers: [
            {
                ...
                link: 'https://www.ion-club.net/fuerteventura/'
            },
            {
                title: 'Melia Hotel',
                coordinates: {
    ...
    langebaan: {
        marker: {
            title: 'Langebaan',
            link: '/destinations/langebaan-spot-guide',
            coordinates: {
                lat: -33.082824,
                long: 18.029206
            },
